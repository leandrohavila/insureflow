...
export type ValidationRuleV1 =
  | { type: "required"; when?: "always" | "finalize" }
  ...
  | { type: "cnpj"; message?: string }
  | { type: "cep"; message?: string }
  | { type: "phone"; message?: string }
  | { type: "email"; message?: string }
  | { type: "url"; message?: string }
  | { type: "plate"; message?: string }
  | { type: "renavam"; message?: string }
  | { type: "chassi"; message?: string }
  | { type: "fileRequired"; message?: string }
  | { type: "minItems"; value: number; message?: string }
  | { type: "maxItems"; value: number; message?: string }
  | { type: "mask"; value: string; message?: string }
