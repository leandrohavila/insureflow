...
export function DashboardHome() {
  ...
  return (
    <motion.div
      ...
      className="flex min-h-0 flex-1 flex-col gap-8 overflow-y-auto overflow-x-hidden px-5 py-6 sm:px-6 md:gap-10 md:px-8 md:py-8 lg:gap-12 xl:px-10 xl:py-10"
    >
      <motion.header
