...
export const CROSS_SELL_STATUS_LABELS: Record<CrossSellStatus, string> = {
  PENDING: "Pendente",
...
export const REACTIVATION_CHANNEL_LABELS: Record<ReactivationChannel, string> = {
  WHATSAPP: "WhatsApp",
  EMAIL: "E-mail",
...
export const COMMERCIAL_RENEWAL_STATUS_LABELS: Record<
  CommercialRenewalStatus,
  string
> = {
  ACTIVE: "Ativa",
  RENEWAL_PENDING: "Pendente",
  RENEWAL_IN_PROGRESS: "Em andamento",
  RENEWED: "Renovada",
  LOST: "Perdida",
}
...
export const MESSAGE_TEMPLATE_KIND_LABELS: Record<string, string> = {
