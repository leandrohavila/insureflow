...
/** @deprecated Use ACTIVITY_EVENT_KINDS */
...
export const ACTIVITY_EVENT_LABELS: Record<ActivityEventKind, string> = {
  ...
  portal_lead_received: "Interesse recebido pelo portal",
  lead_lost: "Lead perdido",
  lead_reactivation_postponed: "Reativação adiada",
  lead_reactivated_campaign: "Lead reativado por campanha",
  campaign_created: "Campanha criada",
  campaign_updated: "Campanha atualizada",
  campaign_started: "Campanha iniciada",
  campaign_finished: "Campanha encerrada",
  campaign_lead_added: "Lead adicionado à campanha",
  campaign_lead_removed: "Lead removido da campanha",
  campaign_followup_created: "Follow-up de campanha criado",
...
/** @deprecated Use activityEventLabel */
export function operationalEventLabel(kind: string | null | undefined): string {
  return activityEventLabel(kind)
}

/**
 * Catálogo espelhado de `apps/api/src/common/utils/activity-event-kinds.util.ts`.
 * Manter sincronizado ao adicionar novos kinds até existir pacote compartilhado.
 */
export const ACTIVITY_EVENT_KINDS_SOURCE = "api/common/utils/activity-event-kinds.util.ts"
