...
/** @deprecated Use dsPipeline.laneWidthPx */

export const CRM_KANBAN_LANE_WIDTH_PX = dsPipeline.laneWidthPx

/** @deprecated Use dsPipeline.laneMinWidthPx */

export const CRM_KANBAN_LANE_MIN_PX = dsPipeline.laneMinWidthPx

/** @deprecated Use dsPipeline.laneCompactWidthPx */

export const CRM_KANBAN_LANE_WIDTH_COMPACT_PX = dsPipeline.laneCompactWidthPx



/** @deprecated Use dsPipeline.board.className */

export const CRM_KANBAN_ROOT = dsPipeline.board.className



/** @deprecated Use dsPipeline.scroll.className */

export const CRM_KANBAN_SCROLL = dsPipeline.scroll.className



/** @deprecated Use dsPipeline.columns.className */

export const CRM_KANBAN_COLUMNS = dsPipeline.columns.className
